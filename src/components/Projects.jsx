                ...
                <div className="grid grid-cols-1 lg:grid-cols-6 gap-10">
                    {portfolioData.projects.map((project, index) => (
                        <motion.div
                            ...
                            className={`group relative overflow-hidden rounded-[2.5rem] border border-white/5 bg-slate-900/50 backdrop-blur-xl hover:border-sky-500/30 transition-all duration-500 flex flex-col ${index === 0 ? 'md:col-span-4 md:row-span-2' : 'md:col-span-2'}`}
                        >
                            ...
                            <div className="p-8 md:p-10 flex flex-col justify-between h-full relative z-10">
                                <div className="flex flex-col h-full">
                                    <div className="flex flex-col items-center text-center mb-6">
                                        <h3 className="text-3xl font-black text-white group-hover:text-sky-400 transition-colors tracking-tight leading-tight mb-4" style={{ marginTop: "20px" }}>
                                            {project.title}
                                        </h3>
                                    ...
                                    <p className="text-slate-400 text-base leading-relaxed mb-auto font-medium text-center" style={{ margin: "10px" }}>
                                        {project.description}
                                    </p>
